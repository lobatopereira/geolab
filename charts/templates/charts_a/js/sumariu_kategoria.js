...
var endpoint = '/api/c/g/sumariu/ekipamentu/inventaria/tuir/kategoria/'
$.ajax({
    method: "GET",
    url: endpoint,
    success: function(data){
        ...
        const gEquipmentInventariaByKategoria_data = new Chart(
            document.getElementById('gEquipmentInventariaByKategoria_data'),
            config_chart
        );
    },
